<template><section class="page"><van-nav-bar title="记一笔" left-arrow @click-left="router.back()" /><TransactionForm :loading="loading" @submit="save" /><van-notice-bar v-if="error" color="#c92a2a" background="#fff1f0">{{ error }}</van-notice-bar></section></template>
